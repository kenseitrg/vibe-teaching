...
| Figure | Path |
|--------|------|
| Layer replacement workflow | `figures/term01_lec04/term01_lec04_layer_replacement.png` |
| Cross-correlation statics | `figures/term01_lec04/term01_lec04_crosscorrelation_statics.png` |
| 4-component model | `figures/term01_lec04/term01_lec04_four_component_model.png` |
| Statics bias velocity analysis | `figures/term01_lec04/term01_lec04_statics_velocity_bias.png` |
| Floating datum | `figures/term01_lec04/term01_lec04_floating_datum.png` |
| Velocity and statics (ray paths and traveltime curves) | `figures/term01_lec04/term01_lec04_velocity_and_statics.png` |

## Lecture materials

- English notes: `lecture_notes/en/term01_lec04_advanced_statics_and_velocity_link.en.md`
- Rendered PDF: `lecture_notes/en/term01_lec04_advanced_statics_and_velocity_link.en.pdf`
...
- Exercises: `exercises/term01_lec04_advanced_statics_and_velocity_link.md`
...
- This lecture is the second half of the original kinematics/statics lecture. Lecture 03 must be covered first.
...
- The new ray-path/traveltime figure (`term01_lec04_velocity_and_statics.png`) is useful for showing the link between topography, datums, and the recorded traveltime curve before introducing the hyperbola equation.
